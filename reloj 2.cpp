...
int main() {
    ...
    {   
        ...
        cout<<endl<<endl<<"          Presione barra espaciadora para acceder al menu de opciones...";
        cout<<endl<<endl;
        consultarAlarmas();
...
void nuevaAlarma()
{
     ...
     while(continuar)
     {
         ...
         if(horasNA >= 0 && horasNA <= 23 && minutosNA >= 0 && minutosNA <= 59 && segundosNA >= 0 && segundosNA <= 59)
         {
            ...
            {
                cout<<endl<<endl<<"Gracias por usar el sistema, adios.";
                cout<<endl<<endl;
                continuar = false;
                cin.get();
                system("CLS");
            ...
            {
                cout<<endl<<endl<<"Opcion incorrecta, intente nuevamente!";
                cout<<endl<<endl;
                continuar = false;
                cin.get();
                //system("pause");
         ...
         {
             cout<<endl<<endl<<"Hora no válida, intente nuevamente!";
             cout<<endl<<endl;
             continuar = true;
             cin.get();
             //system("pause");
...
{    
    ...
    cout<<endl<<endl<<"Alarma almacenada exitosamente con el Id: "<<idAlarma<<endl;     
    return true;
}
